...
class ExternalApiTest(TestCase):
    ...
    def test_ipv4_site(self):
        self.assertEqual(self.ip_handler.payload_validation('1.1.1.1'), ['1.1.1.1', 'ip'])
    ...
    def test_www_url_site(self):
        self.assertEqual(self.ip_handler.payload_validation('www.sofomo.com'),
                         ['www.sofomo.com', 'url'])

    def test_url_site(self):
        self.assertEqual(self.ip_handler.payload_validation('sofomo.com'),
                         ['sofomo.com', 'url'])

    def test_https_url_site(self):
        self.assertEqual(self.ip_handler.payload_validation('https://sofomo.com'),
                         ['sofomo.com', 'url'])
    ...
    def test_http_url_site(self):
        self.assertEqual(self.ip_handler.payload_validation('http://sofomo.com'),
                         ['sofomo.com', 'url'])
